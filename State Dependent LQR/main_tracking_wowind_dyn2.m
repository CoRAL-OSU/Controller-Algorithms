...
%  y(8:10)=y(8:10)- params.meanvel;%NOT NEEDED SINCE THE DYNAMICS DOESNOT
% HAVE VEOCITY COMPONENT WHEN LINEARIZED
...
%wind_vel_now=params.meanvel; %constant wind
...
dvg = double([0;0;params.m*params.g] + quater_rot(q)*cn);  %ground velocity part
R=quater_rot(q);
vr=v-wind_vel_now';
