...
hold on
plot(t,drag2(:,2),'b*')%'LineWidth',1.2)
...
hold on
plot(t,drag2(:,3),'b*')%,'LineWidth',1.2)
hold on
...
hold on
plot(t,drag2(:,4),'b*')%,'LineWidth',1.2)
...
legend("Model 1","Model 2","Model 3","Nominal")
...
hold on
plot(t,drag2(:,12),'b*')%,'LineWidth',1.2)
...
hold on
plot(t,drag2(:,13),'b*')%,'LineWidth',1.2)
...
hold on
plot(t,drag2(:,14),'b*')%,'LineWidth',1.2)
% 
...
hold on
plot(t,drag2(:,15),'b*')%,'LineWidth',1.2)
