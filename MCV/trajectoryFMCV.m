function Soln = trajectoryFMCV(t,linSys,params,tol)
% 
% Asma Tabassum
...
userFun = @(t,z)rhs(t,z,linSys,params, nState);
...
function dz = rhs(t,z,linSys,params,nState)
Q=params.Q;
R=params.R;
G=params.G;
W=params.W;
...
[dM, dH] = coupled_ricatti(A,B,G,W,Q,R,M,H,gaama);
